...
def summarize_article(title, content, category):
    system_prompt = (
        ...
        "- S2: MUST answer one of: (A) Who benefits financially? (B) What past policy does this contradict? (C) What is NOT being reported? (D) How does this affect Japan specifically (yen/energy/exports/security)? Always cite a specific fact from source.\n"
        "- S3: One sharp conclusion. BANNED endings: 〜試される局面だ/〜に備えられているか/〜が予想される/〜と見られる. USE instead: 〜という判断は妥当だ/〜は過去にも失敗している/〜が本質的な問題だ/〜には無理がある/〜が示している\n"
