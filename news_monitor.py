...
def screen_article(title, summary="", recent_titles=None):
    ...
    prompt = (
        ...
        "1. Is this newsworthy? Answer yes if: war/conflict, diplomacy/summit, economic news, politics, business/corporate news, crime, social issues, sports, science/tech, environment. Answer no if: clearly trivial, opinion pieces, roundups/summaries of already-known events, 'what to watch' preview articles, political cartoons/satire compilations, weekly photo galleries, 'best of' collections, news quizzes, photo essays, 'in pictures' articles, investment fund filings, SEC filings, stock portfolio updates, ETF holdings changes, weekly stock price movements, sports league standings or match previews, or vague titles like 'What in the World'.\n"
