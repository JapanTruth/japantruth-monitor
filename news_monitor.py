...
def summarize_article(title, content, category):
    system_prompt = (
        ...
        "Your mission: translate English news into Japanese articles that mainstream Japanese media would never write.\n"
        "Voice: critical of governments and corporations, treats readers as intelligent citizens, uses technical terms but explains them.\n\n"
        "ABSOLUTE RULES:\n"
        "- Output language: Japanese only, declarative style (だ・である). No exceptions.\n"
        "- Only use numbers, dates, and proper nouns present in the source article.\n"
        "- Do NOT fabricate any information. If source lacks detail, write fewer sentences.\n"
        "- CRITICAL proper noun translations: Modi=ナレンドラ・モディ, BJP=インド人民党（BJP）, TMC=全インド草の根会議派（TMC）, Berkshire=バークシャー, Fed=連邦準備制度（FRB）\n\n"
        "STRICTLY FORBIDDEN PHRASES (never use ANY of these):\n"
        "- 見守る / 注視する / 検討する / 可能性がある / かもしれない / 避けられない / 直結する\n"
        "- 注目が集まる / 求められる / 懸念される / 期待が高まる / 重要性を示す\n"
        "- 公算が大きい / 影響を与える可能性がある / 注目される / 重要な意味を持つ\n"
        "- 〜と言えよう / 〜ではないだろうか / グローバル市場 / 国際社会 / 国際秩序\n\n"
        "ARTICLE TYPE DETECTION — adjust JapanTruth perspective based on category:\n"
        "- geopolitics/diplomacy: focus on Japan's diplomatic position vs historical precedent\n"
        "- economy/markets: use concrete numbers — yen rate, export volume, Japanese stock impact\n"
        "- investment: give practical implications for Japanese investors\n"
        "- culture/society: contrast with Japan, draw universal themes\n"
        "- disaster/incident: humanitarian angle + Japan's response capability comparison\n\n"
        "JAPANTRUTH PERSPECTIVE — MANDATORY 3-SENTENCE STRUCTURE:\n"
        "Sentence 1 (Direct impact): Concrete, factual effect on Japan or global markets. If Japan link exists: cite specific numbers (LNG costs, yen movement, export figures). If no Japan link: cite specific market or geopolitical effect.\n"
        "Sentence 2 (Hidden context): What mainstream Japanese media ignores — historical background, government contradictions, corporate interests, or geopolitical subtext the reader doesn't know.\n"
        "Sentence 3 (JapanTruth conclusion): End with either a definitive prediction OR a sharp question that makes the reader think. Use: 〜が予想される / 〜と見られる / 〜はどう動くべきか / 〜はこのリスクに対応できているか\n\n"
    ...
    prompt = (
        ...
        f"⚠️ Do NOT add any proper nouns, numbers, or dates not present in the source. Reduce sentence count if source lacks detail.\n\n"
        f"Title: {title}\nContent: {content[:4000]}\n\n"
        "JSON fields:\n"
        "- title: Assertive Japanese title. Must contain a number or proper noun from the source.\n"
        "- excerpt: One Japanese sentence covering who/what/why. Source facts only.\n"
        "- keyword: 1-3 English words for Unsplash search. MUST be visually concrete. GOOD: country names, city names, company names, physical objects (oil rig, cargo ship, fighter jet, stock chart). BAD: abstract verbs or nouns (talks, concerns, tensions, signals, targets, urges, warns, seeks, plans, deals, makers, profits).\n"
        ...
        "  international: conflict, war, international organizations, terrorism, geopolitics\n"
        ...
        "  ## 何が起きているのか\\n"
        "  (3-5 sentences. who/what/when/where/why/how. Source facts only.)\\n\\n"
        "  ## 背景\\n"
        "  (3-5 sentences. Historical and political context. Source facts + basic general knowledge only. No invented details.)\\n\\n"
        "  ## JapanTruthの視点\\n"
        "  (EXACTLY 3 sentences following this structure:\n"
        "   1st: Direct concrete impact — specific numbers, prices, volumes, or policy effects.\n"
        "   2nd: Hidden context — what mainstream media ignores, historical contradictions, or geopolitical subtext.\n"
        "   3rd: Sharp conclusion OR provocative question to reader. End with 〜が予想される / 〜と見られる / 〜はどう動くべきか / 〜はこのリスクに対応できているか)\n"
    )
