...
def summarize_article(title, content, category):
    system_prompt = (
        ...
        "- Secretary of State=国務長官 (NOT 外務大臣)\n"
        "- Kyiv=キーウ (NOT キエフ)\n"
        "- GameStop=ゲームストップ (NOT ゲーマーストップ)\n"
        "- Hantavirus=ハンタウイルス (NOT ハンターバイラス/ハンタナウス/ハンターウイルス)\n"
        "- Attorney General=司法長官 (NOT 検事総長)\n"
        ...
        "  Must BEGIN with a specific number, company name, or country name from the source. Never begin with 同社/同国/同氏/同組織/この/その (these are vague references — use the actual name).\n"
        ...
        "\n"
        "TITLE QUALITY RULES:\n"
        "- Title MUST contain at least one specific: number, person name, place name, or company name.\n"
        "- BANNED title endings: 〜が発表 / 〜が明らかに / 〜を表明 / 〜を発表 / 〜となった / 〜した\n"
        "- Title must answer WHY this matters, not just WHAT happened.\n"
        "- Title length: 20-40 characters ideal.\n"
        "\n"
        "EXCERPT QUALITY RULES:\n"
        "- Minimum 50 characters. Maximum 120 characters.\n"
        "- Must state the single most important fact.\n"
        "- BANNED excerpt endings: 〜が発表された / 〜が明らかになった / 〜が行われた / 〜が報じられた / 〜が確認された\n"
        "\n"
        "BODY QUALITY RULES:\n"
        "- \"何が起きているのか\" section (What is happening): minimum 3 sentences.\n"
        "- \"背景\" section (Background): minimum 2 sentences. NEVER write 省略 or leave empty. Facts from source only.\n"
        "\n"
        "TYPO/MISTRANSLATION PREVENTION:\n"
        "- Double-check katakana: ウ/ヴ confusion, ー length marks, small/large kana.\n"
        "- Numbers: re-read every number. trillion≠兆×1000.\n"
        "- Do NOT write 来日/訪日/帰国 unless source explicitly states the person traveled to Japan.\n"
        "- Do NOT fabricate any visits, meetings, quotes, or travel not stated in source.\n"
    ...
    prompt = (
        ...
        "   STRICT: If you cannot write 2 full sentences using ONLY source facts: write '## 背景\\n省略' and move on.\n"
