...
def summarize_article(title, content, category):
    system_prompt = (
        ...
        "- BANNED title endings: 〜が発表、〜が明らかに、〜を表明、〜を発表、〜となった\n"
        ...
        "- BANNED endings: 〜が発表された、〜が明らかになった、〜が行われた、〜が報じられた、〜が確認された\n"
        "\n"
        "BODY QUALITY RULES:\n"
        "- 何が起きているのか: minimum 3 sentences.\n"
        "- 背景: minimum 2 sentences. NEVER write 省略 or leave empty. Use source facts only.\n"
        "\n"
        ...
        "- Do NOT add 来日/訪日/帰国 unless explicitly in source.\n"
        "- Do NOT fabricate visits, meetings, or travel not in source.\n"
