...
def summarize_article(title, content, category):
    system_prompt = (
        ...
        "- Mohammed bin Salman=ムハンマド・ビン・サルマン（サウジアラビア皇太子、MBS）\n"
        "- Recep Tayyip Erdogan=レジェップ・タイイップ・エルドアン（トルコ大統領）\n"
        "- Ahmed al-Sharaa=アフマド・アル＝シャラア（シリア暫定指導者）\n"
        "- Abdel Fattah el-Sisi=アブデルファッターフ・エルシーシ（エジプト大統領）\n"
        ...
        "- Yoon Suk-yeol=尹錫悦（元韓国大統領、2024年12月戒厳令宣布→弾劾）\n"
        "- Lai Ching-te=頼清徳（台湾総統）\n"
        "\n"
        "== 日本 ==\n"
        "- Sanae Takaichi=高市早苗（首相、第105代、2026年2月就任）\n"
        "- Shigeru Ishiba=石破茂（元首相）\n"
        "- Fumio Kishida=岸田文雄（元首相）\n"
        "- Yoshihide Suga=菅義偉（元首相）\n"
        "\n"
        "== 南・東南アジア ==\n"
        "- Narendra Modi=ナレンドラ・モディ（インド首相）\n"
        "- Prabowo Subianto=プラボウォ・スビアント（インドネシア大統領）\n"
        "- Anwar Ibrahim=アンワル・イブラヒム（マレーシア首相）\n"
        "- Anutin Charnvirakul=アヌティン・チャーンウィラクン（タイ首相、2026年2月再選）\n"
        "- Anthony Albanese=アンソニー・アルバニージー（オーストラリア首相）\n"
        "\n"
        "== 中南米・アフリカ ==\n"
        "- Nicolas Maduro=ニコラス・マドゥロ（元ベネズエラ大統領、2026年1月米軍に拘束・NY裁判中）\n"
        ...
        "- Bola Tinubu=ボラ・ティヌブ（ナイジェリア大統領）\n"
        "\n"
        "== 国際機関 ==\n"
        "- Antonio Guterres=アントニオ・グテーレス（国連事務総長）\n"
        "- Tedros Adhanom=テドロス・アダノム（WHO事務局長）\n"
        "- Kristalina Georgieva=クリスタリナ・ゲオルギエバ（IMF専務理事）\n"
        "- Jerome Powell=ジェローム・パウエル（FRB議長）\n"
        "- Christine Lagarde=クリスティーヌ・ラガルド（ECB総裁）\n"
        "- Ajay Banga=アジェイ・バンガ（世界銀行総裁）\n"
        "- Rafael Grossi=ラファエル・グロッシ（IAEA事務局長）\n"
        "- Karim Khan=カリム・カーン（ICC検察官）\n"
        "- Fed / Federal Reserve=連邦準備制度（FRB）\n"
        "- Hamas=ハマス, Hezbollah=ヒズボラ, Houthis=フーシ派\n"
        "- BJP=インド人民党（BJP）, TMC=全インド草の根会議派（TMC）\n"
        "\n"
        "== 宗教指導者 ==\n"
        "- Pope Leo XIV=教皇レオ14世（本名ロバート・フランシス・プレヴォスト、初のアメリカ人教皇、2025年5月就任）\n"
        "- Pope Francis=フランシスコ教皇（前教皇、2025年4月逝去）\n"
        "\n"
        "== テック・経済 ==\n"
        "- Jeff Bezos=ジェフ・ベゾス（Amazon創業者）\n"
        "- Mark Zuckerberg=マーク・ザッカーバーグ（Meta CEO）\n"
        "- Sam Altman=サム・アルトマン（OpenAI CEO）\n"
        "- Sundar Pichai=サンダー・ピチャイ（Google CEO）\n"
        "- Satya Nadella=サティア・ナデラ（Microsoft CEO）\n"
        "- Tim Cook=ティム・クック（Apple CEO）\n"
        "- Jensen Huang=ジェンスン・フアン（NVIDIA CEO）\n"
        "- Warren Buffett=ウォーレン・バフェット（Berkshire Hathaway=バークシャー・ハサウェイ）\n"
        "- Masayoshi Son=孫正義（ソフトバンクCEO）\n"
        "- Larry Fink=ラリー・フィンク（BlackRock CEO）\n"
        "- Janet Yellen=ジャネット・イエレン（元財務長官）\n"
        "\n"
        "== スポーツ・王室 ==\n"
        ...
        "- Shohei Ohtani=大谷翔平\n"
        "- King Charles III=チャールズ3世（英国王）\n"
        "- Prince William=ウィリアム皇太子\n"
        "- Emperor Naruhito=天皇陛下（徳仁）\n"
        "\n"
        "== 軍事・法律用語 ==\n"
        "- Mogami=もがみ型（固有名詞、艦艇）\n"
        "- Political Commissar=政治委員（政治委員長は誤り）\n"
